// SyncStatusChip — header indicator + force-sync popover (fix-sync-sign-in-
// lifecycle M3). Renders one of five visual states reflecting engine activity
// so the user can tell at a glance whether their writes are being saved.
//
// Hidden when unauthed (sync engine is dormant).
...
export function SyncStatusChip({
  ...
  // Tick once per 30s so 「X 分鐘前」 stays fresh while popover is open.
