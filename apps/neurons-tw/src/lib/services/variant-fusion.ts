 ...
 * individuals of one rarity tier within a family → mint one individual of the
 * next-rarer tier. No energy, no new currency, no rarity-weight change (loot
 * product principle). Reuses the mint reveal / provenance / achievement flow.
 *
