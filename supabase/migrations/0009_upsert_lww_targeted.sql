-- =====================================================================
-- 0009_upsert_lww_targeted.sql
-- implement-targeted-fate-card-tickets — extend upsert_lww whitelist +
-- dispatch for the two new 二階 collection tables (targeted_tickets and
-- targeted_ticket_history) introduced by migration 0008.
--
...
-- only deltas from 0006 are (a) the whitelist now accepts
-- 'targeted_tickets' and 'targeted_ticket_history', and (b) two new
-- ELSIF branches dispatch their upserts.
-- =====================================================================
