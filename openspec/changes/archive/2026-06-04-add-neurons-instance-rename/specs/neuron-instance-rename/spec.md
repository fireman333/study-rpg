...
- **WHEN** a family has surplus individuals of a rarity tier, some of which carry nicknames
- **THEN** `eligibleSurplusByTier` and `promoteTier` behave exactly as before (oldest-held-per-slot protected, surplus consumed)
