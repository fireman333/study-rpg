...
| M3 — 公開 API + dogfood fork validation | ✓ `@study-rpg/core@0.1.0` 發 npm (2026-05-16) + ✓ `docs/CONTENT_SCHEMA.md` / `THEME_API.md` 完整 + ⏳ migrate-m2nd-to-published-core（二階 fork `workspace:*` → `^0.1.0` 真實 consume published pkg） | ⏳ 2/3 |
