...
| M5 — 養成元素加深 | 宿舍場景 + cosmetic unlock + 導師 NPC 每日一題 + ✓ **模擬考全套（36 papers / stopwatch / auto-pause / 全展開詳解 / 個人進步曲線 / boss-tier reward burst / SRS enqueue）** | 🚧 mock exam ✓；宿舍 + cosmetic + 導師 NPC 仍 ⏳ |
