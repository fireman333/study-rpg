# hospital-tutorial Specification

## Purpose

遊戲教學系統 — 四層架構：L1 onboarding modal（7 步 click-next）/ L2 per-surface 首訪 hint / L3 state-trigger toast tips / L4 always-available HelpMenu（❓ FAB）。Flag bags in gameCounters.tutorial.{completedSteps, firstVisit, firedTips}.
