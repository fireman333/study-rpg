...
This capability SHALL leave the app's inline emoji as native system color emoji and SHALL NOT replace them with pixel-art sprites or a pixel emoji font. Emoji pixelization is explicitly deferred to a future follow-up.
