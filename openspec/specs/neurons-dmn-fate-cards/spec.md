...
- `dmnLastDailyResetDate` — the local-TZ date string (YYYY-MM-DD) for which the above counters are valid
...
- **GIVEN** local state has `dmnLastDailyResetDate = 2026-06-07`, `dmnTimeAxisDrawsConsumedToday = 1`
