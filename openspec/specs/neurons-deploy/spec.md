...
- **THEN** a post-deploy check SHALL fetch `cram.json` and the PDFs on the production host and assert the responses parse as the expected content type (not HTML)
